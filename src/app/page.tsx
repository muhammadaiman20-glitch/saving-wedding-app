...
export default function Page() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8">
      <h1 className="text-4xl font-bold text-white mb-8">Saving Wedding App</h1>
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 w-full max-w-6xl">
        <Link href="/savings" className="glass rounded-xl p-6 text-center hover:scale-105 transition-transform">
